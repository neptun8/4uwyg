     ...
     if(mouseEvent=="mouseDown")
{
    ...
    console.log("current position of x and y coordanates =");
...
function my_touchmove(e)
{
    ...
    console.log("Last_position of x and y coordinates=");
    console.log("x="+ last_position_of_touch_x+"y="+ last_position_of_touch_y)
    ctx.moveTo(last_position_of_touch_x,last_position_of_touch_y);

    console.log("currentt_position of x and y coordinates=");
